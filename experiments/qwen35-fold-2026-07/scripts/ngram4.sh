...
run "--spec-type ngram-simple --spec-draft-n-max 8 --override-kv qwen35moe.expert_used_count=int:6" "ng-n8-k6"
run "--spec-type ngram-simple --spec-draft-n-max 24 --override-kv qwen35moe.expert_used_count=int:6" "ng-n24-k6"
run "--spec-type ngram-simple --spec-draft-n-max 32 --override-kv qwen35moe.expert_used_count=int:6" "ng-n32-k6"
run "--override-kv qwen35moe.expert_used_count=int:6" "nospec-k6"
