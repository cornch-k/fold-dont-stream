...
run "--spec-type ngram-simple"  "ngram-simple"
run "--spec-type ngram-map-k4v" "ngram-map-k4v"
run "--spec-type ngram-mod"     "ngram-mod"
run "--spec-type ngram-cache"   "ngram-cache"
