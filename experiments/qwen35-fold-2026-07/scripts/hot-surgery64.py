...
DST = '/Users/angigyeom/Desktop/DEV/fun/accelerator/models/qwen35-v2a-hot64.gguf'

hot = {}
for line in open('/Users/angigyeom/Desktop/DEV/fun/accelerator/exp/hot64_ids.txt'):
    p = line.split()
