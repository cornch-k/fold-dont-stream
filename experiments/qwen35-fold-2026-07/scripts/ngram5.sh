...
run "--spec-type ngram-simple --spec-draft-n-max 4 --override-kv qwen35moe.expert_used_count=int:6" "ng-n4-k6"
run "--spec-type ngram-simple --spec-draft-n-max 6 --override-kv qwen35moe.expert_used_count=int:6" "ng-n6-k6"
run "--spec-type ngram-simple --spec-draft-n-max 12 --override-kv qwen35moe.expert_used_count=int:6" "ng-n12-k6"
run "--spec-type ngram-simple --spec-draft-n-max 8 --override-kv qwen35moe.expert_used_count=int:6 -ctk q8_0 -ctv q8_0" "ng-n8-k6-kv8"
