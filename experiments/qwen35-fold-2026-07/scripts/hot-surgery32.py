...
DST = '/Users/angigyeom/Desktop/DEV/fun/accelerator/models/qwen35-v2a-hot32.gguf'

hot = {}
for line in open('/Users/angigyeom/Desktop/DEV/fun/accelerator/exp/hot32_ids.txt'):
    p = line.split()
