...
run "--spec-type ngram-simple --spec-draft-n-max 8" "ng-n8"
run "--spec-type ngram-simple --spec-draft-n-max 16" "ng-n16"
run "--spec-type ngram-simple --spec-draft-n-max 24" "ng-n24"
run "--spec-type ngram-simple --spec-draft-n-max 16 --override-kv qwen35moe.expert_used_count=int:4" "ng-n16-k4"
