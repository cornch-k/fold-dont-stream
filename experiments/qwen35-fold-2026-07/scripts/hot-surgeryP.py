...
DST = '/Users/angigyeom/Desktop/DEV/fun/accelerator/models/qwen35-v2a-hotP.gguf'

hot = {}
for line in open('/Users/angigyeom/Desktop/DEV/fun/accelerator/exp/hot32all_ids.txt'):
    p = line.split()
